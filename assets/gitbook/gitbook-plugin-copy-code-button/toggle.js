require(["gitbook", "jquery"], function (gitbook, $) {
    ...
    gitbook.events.bind("page.change", function () {
        $("pre").each(function () {
            ...
            $copyCodeButton.css({ "position": "absolute", "top": "5px", "right": "5px", "padding": "3px", "background-color": "#313E4E", "color": "white", "border-radius": "5px", "-moz-border-radius": "5px", "-webkit-border-radius": "5px", "border": "2px solid #CCCCCC", "font-size": "0.8em" });
